...
export function CardHover({ product }: { product: ProductType }) {
  ...
  return (
    <motion.div
      ...
      className="group relative w-full rounded-xl bg-card border border-border p-4 transition-colors duration-300 hover:border-accent"
    >
      <div 
      ...
      <div className="relative z-10" style={{ transform: "translateZ(50px)" }}>
        ...
        <div className="absolute inset-x-0 -bottom-2 translate-y-full opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 pt-4">
          <button className="w-full bg-accent hover:bg-accent-2 text-white font-body font-medium py-2 rounded-md transition-colors text-sm uppercase tracking-wider">
            Añadir al carrito
          </button>
        </div>
      </div>
